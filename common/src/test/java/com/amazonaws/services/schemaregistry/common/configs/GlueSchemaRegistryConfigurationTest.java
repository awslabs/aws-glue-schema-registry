...
public class GlueSchemaRegistryConfigurationTest {
    ...
    /**
     * Tests source registry name
     */
//    @Test
//    public void testValidateAndSetSourceRegistryName_withSourceRegistryConfig() {
//        String expectedRegistryName = "test-registry";
//        Properties props = createTestProperties();
//        props.put(AWSSchemaRegistryConstants.SOURCE_REGISTRY_NAME, expectedRegistryName);
//        GlueSchemaRegistryConfiguration glueSchemaRegistryConfiguration = new GlueSchemaRegistryConfiguration(props);
//
//        assertEquals(expectedRegistryName, glueSchemaRegistryConfiguration.getSourceRegistryName());
//    }

    /**
     * Tests target registry name
     */
//    @Test
//    public void testValidateAndSetTargetRegistryName_withTargetRegistryConfig() {
//        String expectedRegistryName = "test-registry";
//        Properties props = createTestProperties();
//        props.put(AWSSchemaRegistryConstants.TARGET_REGISTRY_NAME, expectedRegistryName);
//        GlueSchemaRegistryConfiguration glueSchemaRegistryConfiguration = new GlueSchemaRegistryConfiguration(props);
//
...
//    }
     ...
     */
//    @Test
//    public void testValidateAndSetTargetRegistryName_withRegistryConfig() {
//        String expectedRegistryName = "test-registry";
//        Properties props = createTestProperties();
//        props.put(AWSSchemaRegistryConstants.REGISTRY_NAME, expectedRegistryName);
//        GlueSchemaRegistryConfiguration glueSchemaRegistryConfiguration = new GlueSchemaRegistryConfiguration(props);
...
//    }
    ...
    /**
     * Tests target endpoint
     */
//    @Test
//    public void testValidateAndSetTargetEndpoint_withTargetEndpointConfig() {
//        String expectedEndpoint = "http://glue.us-east-1";
//        Properties props = createTestProperties();
//        props.put(AWSSchemaRegistryConstants.AWS_TARGET_ENDPOINT, expectedEndpoint);
//        GlueSchemaRegistryConfiguration glueSchemaRegistryConfiguration = new GlueSchemaRegistryConfiguration(props);
//
...
//    }
     ...
     */
//    @Test
//    public void testValidateAndSetTargetEndpoint_withEndpointConfig() {
//        String expectedEndpoint = "http://glue.us-east-1";
//        Properties props = createTestProperties();
//        props.put(AWSSchemaRegistryConstants.AWS_ENDPOINT, expectedEndpoint);
//        GlueSchemaRegistryConfiguration glueSchemaRegistryConfiguration = new GlueSchemaRegistryConfiguration(props);
//
//        assertEquals(expectedEndpoint, glueSchemaRegistryConfiguration.getTargetEndPoint());
//    }
    ...
    /**
     * Tests source endpoint
     */
//    @Test
//    public void testValidateAndSetSourceEndpoint_withSourceEndpointConfig() {
//        String expectedEndpoint = "http://glue.us-east-1";
//        Properties props = createTestProperties();
//        props.put(AWSSchemaRegistryConstants.AWS_SOURCE_ENDPOINT, expectedEndpoint);
//        GlueSchemaRegistryConfiguration glueSchemaRegistryConfiguration = new GlueSchemaRegistryConfiguration(props);
//
//        assertEquals(expectedEndpoint, glueSchemaRegistryConfiguration.getSourceEndPoint());
//    }
     ...
     */
//    @Test
//    public void testValidateAndSetSourceRegion_withSourceRegionConfig() {
//        String expectedRegion = "us-east-1";
//        Properties props = createTestProperties();
//        props.put(AWSSchemaRegistryConstants.AWS_SOURCE_REGION, expectedRegion);
//        GlueSchemaRegistryConfiguration glueSchemaRegistryConfiguration = new GlueSchemaRegistryConfiguration(props);
//
//        assertEquals(expectedRegion, glueSchemaRegistryConfiguration.getSourceRegion());
//    }
     ...
     */
//    @Test
//    public void testValidateAndSetTargetRegion_withTargetRegionConfig() {
//        String expectedRegion = "us-east-1";
//        Properties props = createTestProperties();
//        props.put(AWSSchemaRegistryConstants.AWS_TARGET_REGION, expectedRegion);
//        GlueSchemaRegistryConfiguration glueSchemaRegistryConfiguration = new GlueSchemaRegistryConfiguration(props);
//
...
//    }
     ...
     */
//    @Test
//    public void testValidateAndSetTargetRegion_withRegionConfig() {
//        String expectedRegion = "us-east-1";
//        Properties props = createTestProperties();
//        props.put(AWSSchemaRegistryConstants.AWS_REGION, expectedRegion);
//        GlueSchemaRegistryConfiguration glueSchemaRegistryConfiguration = new GlueSchemaRegistryConfiguration(props);
//
//        assertEquals(expectedRegion, glueSchemaRegistryConfiguration.getTargetRegion());
//    }
