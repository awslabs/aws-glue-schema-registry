...
@Slf4j
public final class GlueSchemaRegistryDeserializerCache implements GlueSchemaRegistryCache<UUID, Schema, CacheStats> {
     ...
     * Singleton cache.
     */
    private GlueSchemaRegistryDeserializerCache() { }
     ...
     */
    private GlueSchemaRegistryDeserializerCache(Cache<UUID, Schema> cache) {
        this.cache = cache;
    }
     ...
     *
     * @return GlueSchemaRegistryDeserializerCache instance with cache object
     */
    private static GlueSchemaRegistryDeserializerCache createDeserializerCache() {
        return new GlueSchemaRegistryDeserializerCache(CacheBuilder
                .newBuilder()
     ...
     * @return returns a singleton instance for GlueSchemaRegistryDeserializerCache
     */
    public static GlueSchemaRegistryDeserializerCache getInstance(@NonNull GlueSchemaRegistryConfiguration configs) {
    ...
    private static class CacheSingletonHelper {
        private static final GlueSchemaRegistryDeserializerCache INSTANCE = initialize();

        private static GlueSchemaRegistryDeserializerCache initialize() {
