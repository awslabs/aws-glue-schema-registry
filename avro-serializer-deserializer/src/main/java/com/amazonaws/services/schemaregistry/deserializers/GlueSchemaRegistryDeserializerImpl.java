...
public class GlueSchemaRegistryDeserializerImpl implements GlueSchemaRegistryDeserializer {
    ...
    @VisibleForTesting
    protected GlueSchemaRegistryDeserializerImpl(final AWSDeserializer awsDeserializer) {
    ...
    public byte[] getData(final byte[] encodedData) {
        return awsDeserializer.getActualData(encodedData);
    }
    ...
    public Schema getSchema(final byte[] data) {
        return awsDeserializer.getSchema(data);
    }
    ...
    public boolean canDeserialize(final byte[] data) {
        return awsDeserializer.canDeserialize(data);
    }
}
