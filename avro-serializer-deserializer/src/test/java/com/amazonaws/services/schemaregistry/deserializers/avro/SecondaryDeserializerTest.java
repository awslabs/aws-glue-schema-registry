...
public class SecondaryDeserializerTest {
    ...
    public void testSecondaryDeserializer_withStringDeserializer_deserializesSuccessfully() {
        ...
        final String objectToSerialize = "TestData";
    ...
    private Object deserialize(Map<String, Object> deserializerConfigs, byte[] serializedBytes) {
        AWSKafkaAvroDeserializer awsKafkaAvroDeserializer = new AWSKafkaAvroDeserializer(this.mockCredProvider,
                deserializerConfigs);
        awsKafkaAvroDeserializer.setAwsDeserializer(mockAwsDeserializer);
