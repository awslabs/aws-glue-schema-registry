...
public class GlueSchemaRegistrySerializerImpl implements GlueSchemaRegistrySerializer {
    ...
    public GlueSchemaRegistrySerializerImpl(
        ...
        final String region) {
        this.glueSchemaRegistrySerializationFacade = GlueSchemaRegistrySerializationFacade.builder()
                .credentialProvider(awsCredentialsProvider)
                .glueSchemaRegistryConfiguration(new GlueSchemaRegistryConfiguration(region))
                .build();
    }
