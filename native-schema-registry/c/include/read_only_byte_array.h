 ...
 * read error messages.
 */
read_only_byte_array *new_read_only_byte_array(
    unsigned char *data,
    size_t len,
 ...
 */
unsigned char *read_only_byte_array_get_data(const read_only_byte_array *array);

/**
 * Gets the len of the data being pointed by this array.
 */
size_t read_only_byte_array_get_len(const read_only_byte_array *array);
